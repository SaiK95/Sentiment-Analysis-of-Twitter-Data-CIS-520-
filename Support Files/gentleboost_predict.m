function [model, label, precision, confusion, pweight, nweight] = gentleboost_predict(Xtrain, Ytrain, Xtest, Ytest)

t = templateTree;
model = fitensemble(Xtrain,Ytrain,'GentleBoost',500, t);
